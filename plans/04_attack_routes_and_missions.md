...
참조:
- SessionKey/SessionHistoryStore 스키마: `09_server_node_runtime_schema_v0.md` (See DOCS_INDEX.md → 09)
- connect/disconnect/handoff 알고리즘: `11_event_handler_spec_v0_1.md` (See DOCS_INDEX.md → 11)
